...
st.write("Transform your files between csv and excel formats with built-in data cleaning and data analysis")
...
if uploaded_file:
    for file in uploaded_file:
        ...
        columns = st.multiselect(f"Select columns to keep from {file.name}", df.columns, default=df.columns)
        df = df[columns]
